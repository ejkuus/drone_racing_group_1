...
: ${AMENT_CURRENT_PREFIX:="/home/eero/tello_ros_ws/src/install/dronerace"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/dronerace/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/dronerace/environment/path.sh"
